...
contract DonkeyMonkey is Context, IBEP20, Ownable {
    ...
    string private     _name = "DonkeyMonkey";
    string private   _symbol = "DMNK";
    ...
    uint256 private numTokensSellToAddToLiquidity = 40000000000 * 10 **_decimals;
    ...
    function setTeamWallet(address account) external onlyOwner {
        require(account != address(0), "Cannot set team wallet to zero address");
        _teamWallet = account;
        _isExcludedFromFee[_teamWallet]       = true;
        _isExcludedFromAutoLiquidity[_teamWallet] = true;
        _isExcludedFromAntiWhale[_teamWallet] = true;
